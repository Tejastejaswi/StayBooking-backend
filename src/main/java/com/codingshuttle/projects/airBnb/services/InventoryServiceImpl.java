...
import com.codingshuttle.projects.airBnb.repository.InventoryRepository;
...
public class InventoryServiceImpl implements InventoryService {
    ...
    public Page<HotelDto> searchHotels(HotelSearchRequest hotelSearchRequest) {
        ...
        long dateCount =
                ChronoUnit.DAYS.between(hotelSearchRequest.getStartDate(), hotelSearchRequest.getEndDate()) + 1; //  we should add +1 because if we send same
        // StartDate and EndDate ChromoUnit.DAYS.between gives us 0 ;
